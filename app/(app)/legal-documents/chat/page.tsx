        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
              Créez vos documents juridiques avec l'aide d'une intelligence artificielle conversationnelle
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
                ...
                <h3 className="font-bold text-gray-800 mb-2">Conversation IA</h3>
                <p className="text-gray-600 text-sm">L'IA vous guide étape par étape pour créer votre document</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
                ...
                <h3 className="font-bold text-gray-800 mb-2">Export Professionnel</h3>
                <p className="text-gray-600 text-sm">DOCX, PDF et TXT avec formatage professionnel</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
                ...
                <p className="text-gray-600 text-sm">S'adapte à tous types de documents juridiques français</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
            <div className="p-6 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-b border-gray-200/50">
              ...
              <p className="text-gray-600">
                Décrivez le type de document que vous souhaitez créer ou posez une question juridique
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
            ...
            <p className="text-gray-300 leading-relaxed">
              Cette IA génère des documents juridiques basés sur le droit français. 
              Il est <strong className="text-yellow-400">fortement recommandé</strong> de faire vérifier 
              tout document par un professionnel du droit avant signature et utilisation. 
              L'IA peut omettre des éléments spécifiques à votre situation.
            </p>
          </div>
        </div>
      </section>

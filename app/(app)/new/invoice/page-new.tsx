                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-12 p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border border-gray-200">
                    ...
                    <div className="mt-4 text-xs text-green-600 font-medium">
                      ✨ Click any example to try it, or write your own. AI
                      understands multiple languages and handles typos!
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl">
                  <div className="flex items-center">
                    ...
                    <span className="text-green-800 font-medium">
                      Invoice draft generated successfully! Review and edit the
                      details below.
                    </span>
                  </div>
                </div>

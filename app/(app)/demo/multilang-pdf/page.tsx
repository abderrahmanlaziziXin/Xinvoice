                      ...
                      generatedDocument?.document && (
                        <div className="space-y-6">
                          ...
                          <div className="xinfinity-card p-6 bg-green-50 border border-green-200">
                            ...
                            {generatedDocument.document &&
                            Object.keys(generatedDocument.document).length >
                              0 ? (
                              <div className="bg-white rounded-lg p-4">
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-gray-900">
                                      {generatedDocument.document.to?.name ||
                                        generatedDocument.document.clientName ||
                                        "N/A"}
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="text-gray-900">
                                      {generatedDocument.document.total ||
                                        "N/A"}
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="text-gray-900">
                                      {generatedDocument.document.currency ||
                                        "USD"}
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="text-gray-900">
                                      {generatedDocument.document.dueDate ||
                                        "Not set"}
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="text-gray-900">
                                      {generatedDocument.document.items
                                        ?.length || 0}
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                <h4 className="font-medium text-yellow-800 mb-2">
                                  ⚠️ No Document Data Found
                                </h4>
                                <p className="text-sm text-yellow-700 mb-3">
                                  The API response doesn&apos;t contain expected
                                  document data. This might indicate an issue

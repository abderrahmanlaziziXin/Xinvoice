...
export default function InvoiceDetailPage() {
  ...
  }, [invoice?.items, invoice?.taxRate, invoice?.discountAmount, invoice?.shippingAmount, isEditing])
  ...
  const calculateTotals = () => {
    ...
    const total = subtotal + taxAmount - invoice.discountAmount + invoice.shippingAmount
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`block w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      errors.clientId ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-transparent'
                    }`}
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      errors.invoiceNumber ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-transparent'
                    }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      errors.date ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-transparent'
                    }`}
                  />
                  {errors.date && (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      errors.dueDate ? 'border-red-300 focus:border-red-500' : 'border-gray-300 focus:border-transparent'
                    }`}
                  />
                  {errors.dueDate && (
                    ...
                    <div key={index} className="grid grid-cols-12 gap-4 items-start p-4 border border-gray-200 rounded-lg">
                      ...
                      <div className="col-span-4 md:col-span-2">
                        ...
                        {errors[`item_${index}_rate`] && (
                          <p className="mt-1 text-xs text-red-600">{errors[`item_${index}_rate`]}</p>
                        )}
                      </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setInvoice(prev => prev ? { ...prev, taxRate: Number(e.target.value) / 100 } : null)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setInvoice(prev => prev ? { ...prev, discountAmount: Number(e.target.value) } : null)}
                      className="block w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-t border-gray-300 pt-3">
                      <div className="flex justify-between">
                        ...
                        <span className="text-lg font-semibold text-gray-900">{formatCurrency(invoice.total)}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <dl className="space-y-3">
                    <div>
                      ...
                      <dd className="text-sm text-gray-900">{invoice.client?.name || "Unknown Client"}</dd>
                    </div>
                    <div>
